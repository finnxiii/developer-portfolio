		...
		<section id="hero" className="hero">
			...
			<div className="hero__svg-wrap">
				...
				>
					...
					{/* I — blue */}
					<path id="p-I1" d="M 176 12 L 176 148" stroke="var(--c-blue)" strokeWidth="16" strokeLinecap="round" />

					{/* N — green */}
					<path id="p-N1a" d="M 216 148 L 216 12" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />
					<path id="p-N1b" d="M 216 12  L 336 148" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />
					<path id="p-N1c" d="M 336 12  L 336 148" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />

					{/* N — green */}
					<path id="p-N2a" d="M 376 148 L 376 12" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />
					<path id="p-N2b" d="M 376 12  L 496 148" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />
					<path id="p-N2c" d="M 496 12  L 496 148" stroke="var(--c-green)" strokeWidth="16" strokeLinecap="round" />
				</svg>
			</div>
